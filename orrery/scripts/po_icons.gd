...
const GLYPHS := {
	...
	"changshaewer": "<path fill='{F}' d='M26 10H38V14L36 20C48 24 52 34 50 44C48 54 40 58 32 58C24 58 16 54 14 44C12 34 16 24 28 20L26 14Z'/><path fill='{F}' d='M16 30L4 18L8 14L20 26Z'/><path fill='none' stroke='{F}' stroke-width='5' d='M48 26Q60 30 50 44'/><g fill='{D}' opacity='.55'><rect x='36' y='32' width='4' height='4'/><rect x='36' y='39' width='4' height='4'/><rect x='36' y='46' width='4' height='4'/></g><path fill='none' stroke='{D}' stroke-width='2.5' stroke-linecap='round' d='M22 40Q25 42 28 40'/>",
	"cimu": "<path fill='{F}' d='M26 4H38V8C34 12 34 14 40 20C50 28 50 44 42 52L44 60H20L22 52C14 44 14 28 24 20C30 14 30 12 26 8Z'/><g stroke='{D}' stroke-width='3' opacity='.45'><path d='M20 26H44M17 34H47M17 42H47M21 50H43'/></g><circle cx='18' cy='14' r='4' fill='none' stroke='{F}' stroke-width='3'/><circle cx='46' cy='14' r='4' fill='none' stroke='{F}' stroke-width='3'/>",
	"monkcap": "<path fill='{F}' d='M16 30C16 22 22 20 32 20C42 20 48 22 48 30C52 40 50 54 40 58H24C14 54 12 40 16 30Z'/><path fill='{F}' d='M18 20L22 8L30 14L34 6L40 14L46 10L46 20Z'/><path fill='{F}' d='M18 22L4 16L6 12L20 18Z'/><path fill='none' stroke='{F}' stroke-width='4' d='M48 28Q60 34 48 44'/><path fill='none' stroke='{D}' stroke-width='2.5' stroke-linecap='round' d='M24 38Q27 40 30 38M34 38Q37 40 40 38'/>",

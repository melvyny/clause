...
const BREAK_EFFECTS := [
	...
	{"name": "灰釉", "name_en": "Ash Glaze", "desc": "击碎者一方恢复12%最大生命，并清除1个减益。", "desc_en": "The breaker's team heals 12% max HP and removes one harmful effect."},
...
const SPECIES := {
	"chickencup": {
		...
		"tags": ["ming", "painted"], "toughness": 100,
		...
		"base": {"hp": 4700, "atk": 890, "def": 430, "spd": 110, "crit_rate": 25, "crit_dmg": 70, "acc": 20, "res": 15},
		...
		"skills": [
			{"name": "啄火", "name_en": "Fire Peck", "cd": 0, "target": "enemy", "mult": 3.6, "hits": 1, "crack": 30, "anim": "melee",
	...
	"sancaihorse": {
		...
		"skills": [
			{"name": "踏釉", "name_en": "Glaze Stomp", "cd": 0, "target": "enemy", "mult": 1.8, "hits": 2, "crack": 30, "anim": "projectile",
				"desc": "两道三彩釉浪冲击敌人，削减目标10%攻击条。", "desc_en": "Two waves of tri-colour glaze; cuts the target's Attack Bar by 10%.",
				"effects": [{"type": "atb_reduce", "amount": 10, "chance": 100}]},
			...
			{"name": "万马奔腾", "name_en": "Thundering Herd", "cd": 0, "target": "all_enemies", "mult": 2.6, "hits": 1, "crack": 30, "anim": "ultimate",
				"desc": "【奥义】釉色化作万马冲过全体敌人，削减25%攻击条。", "desc_en": "ULTIMATE: A herd of glaze tramples all enemies, cutting their Attack Bar by 25%.",
				"effects": [{"type": "atb_reduce", "amount": 25, "chance": 100}]},
		],
		"upgrades": [
			{"id": "sc_cobalt", "name": "蓝彩", "name_en": "Cobalt Accent", "desc": "踏釉削减攻击条提高到20%。", "desc_en": "Glaze Stomp cuts Attack Bar by 20%.",
				"mods": [{"skill": 0, "atb_reduce": 20}]},
	...
	"phoenixvase": {
		...
		"base": {"hp": 4600, "atk": 930, "def": 420, "spd": 116, "crit_rate": 30, "crit_dmg": 75, "acc": 15, "res": 15},
		...
		"skills": [
			{"name": "凤啄", "name_en": "Phoenix Strike", "cd": 0, "target": "enemy", "mult": 3.6, "hits": 1, "crack": 32, "anim": "melee",
	...
	"yohenbowl": {
		...
		"base": {"hp": 4200, "atk": 790, "def": 420, "spd": 112, "crit_rate": 25, "crit_dmg": 65, "acc": 35, "res": 20},
	...
	"changshaewer": {
		"name": "长沙窑诗文壶", "name_en": "Changsha Poem Ewer", "element": Element.WOOD, "role": "诗人", "role_en": "Poet",
		"tags": ["tang", "painted"], "toughness": 90,
		"origin": {"country": "中国", "country_en": "China", "era": "唐", "era_en": "Tang",
			"piece": "长沙窑青釉褐彩诗文执壶", "piece_en": "Changsha ware ewer with a brown-painted poem"},
		"lore": "壶身上写着一首没人知道作者的诗：「君生我未生，我生君已老。」它把这首诗念给每一个敌人听，听过的都走不动路。",
		"lore_en": "Its belly carries a poem by no one knows whom: \"When you were born, I was not yet; when I was born, you were already old.\" It recites it to every enemy, and none of them can walk away.",
		"base": {"hp": 4800, "atk": 720, "def": 470, "spd": 114, "crit_rate": 15, "crit_dmg": 50, "acc": 40, "res": 20},
		"leader": {"stat": "acc", "value": 15},
		"passive": {"id": "verse", "name": "题诗", "name_en": "Inscribed Verse",
			"desc": "它施加的减益多持续1回合。", "desc_en": "Harmful effects it applies last 1 turn longer."},
		"skills": [
			{"name": "褐彩点染", "name_en": "Brown Splash", "cd": 0, "target": "enemy", "mult": 3.2, "hits": 1, "crack": 28, "anim": "projectile",
				"desc": "从壶嘴泼出褐彩，60%几率【防御破坏】2回合。", "desc_en": "Splashes brown pigment from its spout. 60% chance to Break Defense for 2 turns.",
				"effects": [{"type": "debuff", "status": "def_break", "turns": 2, "chance": 60}]},
			{"name": "君生我未生", "name_en": "Born Too Late", "cd": 3, "target": "all_enemies", "mult": 1.2, "hits": 1, "crack": 22, "anim": "cast",
				"desc": "念出那首诗：攻击全体敌人，70%几率【迟缓】2回合，削减15%攻击条。", "desc_en": "Recites the poem: hits all enemies, 70% chance to Slow for 2 turns, cuts Attack Bar by 15%.",
				"effects": [{"type": "debuff", "status": "slow", "turns": 2, "chance": 70}, {"type": "atb_reduce", "amount": 15, "chance": 100}]},
			{"name": "满壶诗", "name_en": "A Jug Full of Verse", "cd": 0, "target": "all_enemies", "mult": 2.5, "hits": 1, "crack": 40, "anim": "ultimate",
				"desc": "【奥义】整壶的诗句倾泻而出，攻击全体敌人，必定【防御破坏】2回合。", "desc_en": "ULTIMATE: Every verse pours out at once. Hits all enemies and always Breaks Defense for 2 turns.",
				"effects": [{"type": "debuff", "status": "def_break", "turns": 2, "chance": 100}]},
		],
		"upgrades": [
			{"id": "cs_underglaze", "name": "釉下褐绿彩", "name_en": "Underglaze Brown-Green", "desc": "褐彩点染必定【防御破坏】。", "desc_en": "Brown Splash always Breaks Defense.",
				"mods": [{"skill": 0, "effect_chance": 100}]},
			{"id": "cs_applique", "name": "模印贴花", "name_en": "Moulded Appliqué", "desc": "君生我未生裂纹+25。", "desc_en": "Born Too Late deals +25 crack.",
				"mods": [{"skill": 1, "crack": 25}]},
			{"id": "cs_poem", "name": "诗文题记", "name_en": "Written Verses", "desc": "君生我未生冷却-1。", "desc_en": "Born Too Late cooldown -1.",
				"mods": [{"skill": 1, "cd": -1}]},
			{"id": "cs_belitung", "name": "黑石号", "name_en": "Belitung Cargo", "desc": "满壶诗同时让全体队友攻击条+20%（同窑的壶曾随黑石号沉船远销阿拉伯）。", "desc_en": "A Jug Full of Verse also gives allies 20% Attack Bar (its kin sailed for Arabia on the Belitung wreck).",
				"mods": [{"skill": 2, "add_effect": {"type": "atb_boost_allies", "amount": 20}}]},
		],
	},
	"cimu": {
		"name": "瓷母", "name_en": "Mother of Porcelain", "element": Element.EARTH, "role": "法师", "role_en": "Caster",
		"tags": ["qing", "painted"], "toughness": 110,
		"origin": {"country": "中国", "country_en": "China", "era": "清·乾隆", "era_en": "Qing · Qianlong",
			"piece": "各种釉彩大瓶", "piece_en": "Vase with glazes of every kind"},
		"lore": "乾隆让景德镇把会烧的釉全烧在一只瓶上，一共十七种。它是所有瓷器的妈妈，脾气跟着身上的釉一圈一圈地变。",
		"lore_en": "Qianlong had Jingdezhen fire every glaze it knew onto one vase: seventeen of them. She is the mother of all porcelain, and her mood turns with her glazes, band by band.",
		"base": {"hp": 5200, "atk": 760, "def": 500, "spd": 100, "crit_rate": 20, "crit_dmg": 60, "acc": 25, "res": 25},
		"leader": {"stat": "hp_pct", "value": 12},
		"passive": {"id": "seventeen", "name": "十七釉", "name_en": "Seventeen Glazes",
			"desc": "每次行动后，元素沿相生顺序转到下一种（土→金→水→木→火→土）。", "desc_en": "After each action her element turns to the next in the generating cycle (Earth → Metal → Water → Wood → Fire → Earth)."},
		"skills": [
			{"name": "釉彩流转", "name_en": "Turning Glaze", "cd": 0, "target": "enemy", "mult": 3.3, "hits": 1, "crack": 30, "anim": "projectile",
				"desc": "用当前的釉色攻击单体。", "desc_en": "Strikes one enemy in her current glaze.",
				"effects": []},
			{"name": "十七层", "name_en": "Seventeen Bands", "cd": 3, "target": "all_enemies", "mult": 1.1, "hits": 2, "crack": 30, "anim": "cast",
				"desc": "身上的釉带一圈圈甩出，两次攻击全体，40%几率【持续伤害】。", "desc_en": "Her glaze bands spin off: hits all enemies twice, 40% chance of Continuous Damage.",
				"effects": [{"type": "debuff", "status": "dot", "turns": 2, "chance": 40}]},
			{"name": "百釉归宗", "name_en": "Every Glaze Returns", "cd": 0, "target": "all_enemies", "mult": 2.7, "hits": 1, "crack": 50, "anim": "ultimate",
				"desc": "【奥义】所有釉色同时亮起：攻击全体敌人，并给全体队友10%护盾。", "desc_en": "ULTIMATE: Every glaze lights at once: hits all enemies and shields every ally for 10%.",
				"effects": [{"type": "shield_allies", "pct": 10}]},
		],
		"upgrades": [
			{"id": "cm_revolve", "name": "转心瓶", "name_en": "Revolving Core", "desc": "釉彩流转改为两次攻击（每击1.9倍）。", "desc_en": "Turning Glaze strikes twice (1.9x each).",
				"mods": [{"skill": 0, "hits": 2, "mult": 1.9}]},
			{"id": "cm_yangcai", "name": "洋彩", "name_en": "Foreign Enamels", "desc": "十七层冷却-1。", "desc_en": "Seventeen Bands cooldown -1.",
				"mods": [{"skill": 1, "cd": -1}]},
			{"id": "cm_bronze", "name": "仿古铜釉", "name_en": "Faux-Bronze Glaze", "desc": "胎厚+30%。", "desc_en": "Toughness +30%.",
				"mods": [{"toughness_mult": 1.3}]},
			{"id": "cm_imperial", "name": "乾隆御制", "name_en": "Qianlong Mark", "desc": "百釉归宗裂纹+40。", "desc_en": "Every Glaze Returns deals +40 crack.",
				"mods": [{"skill": 2, "crack": 40}]},
		],
	},
	"monkcap": {
		"name": "甜白僧帽壶", "name_en": "Sweet-White Monk's Cap", "element": Element.METAL, "role": "守护", "role_en": "Guardian",
		"tags": ["ming", "mono"], "toughness": 130,
		"origin": {"country": "中国", "country_en": "China", "era": "明·永乐", "era_en": "Ming · Yongle",
			"piece": "甜白釉僧帽壶", "piece_en": "'Sweet-white' monk's-cap ewer"},
		"lore": "白得像糖一样，所以叫「甜白」。壶口是一顶僧帽，它总是先把帽檐扣在最危险的队友头上。",
		"lore_en": "So white it looks like sugar, hence \"sweet white\". Its rim is a monk's cap, and it always tips that cap over whichever ally is in the most danger.",
		"base": {"hp": 6200, "atk": 580, "def": 700, "spd": 100, "crit_rate": 15, "crit_dmg": 50, "acc": 20, "res": 40},
		"leader": {"stat": "def_pct", "value": 15},
		"passive": {"id": "sweet_white", "name": "甜白", "name_en": "Sweet White",
			"desc": "队友崩裂时，立即为其加上15%最大生命的金釉护盾。", "desc_en": "When an ally breaks, it instantly gains a gold shield of 15% max HP."},
		"skills": [
			{"name": "帽檐一扣", "name_en": "Cap Knock", "cd": 0, "target": "enemy", "mult": 3.0, "hits": 1, "crack": 30, "anim": "melee",
				"desc": "用僧帽敲下去，30%几率【眩晕】1回合。", "desc_en": "Knocks with its cap. 30% chance to Stun for 1 turn.",
				"effects": [{"type": "debuff", "status": "stun", "turns": 1, "chance": 30}]},
			{"name": "甜白护持", "name_en": "Sweet-White Ward", "cd": 3, "target": "all_allies", "mult": 0.0, "hits": 0, "crack": 0, "anim": "cast",
				"desc": "全体队友获得16%护盾，并清除所有减益。", "desc_en": "Shields all allies for 16% and removes all harmful effects.",
				"effects": [{"type": "shield_allies", "pct": 16}, {"type": "cleanse_allies"}]},
			{"name": "永乐之光", "name_en": "Light of Yongle", "cd": 0, "target": "all_allies", "mult": 0.0, "hits": 0, "crack": 0, "anim": "ultimate",
				"desc": "【奥义】全体队友恢复10%生命、修补裂纹、获得15%护盾和【防御强化】2回合。", "desc_en": "ULTIMATE: All allies heal 10%, mend their cracks, gain a 15% shield and Defense Up for 2 turns.",
				"effects": [{"type": "heal_allies", "pct": 10}, {"type": "shield_allies", "pct": 15}, {"type": "buff_allies", "status": "def_up", "turns": 2}]},
		],
		"upgrades": [
			{"id": "mc_anhua", "name": "暗花", "name_en": "Hidden Decoration", "desc": "甜白护持护盾提高到24%。", "desc_en": "Sweet-White Ward shields for 24%.",
				"mods": [{"skill": 1, "shield_add": 8}]},
			{"id": "mc_tibetan", "name": "藏文款", "name_en": "Tibetan Inscription", "desc": "帽檐一扣眩晕几率提高到60%。", "desc_en": "Cap Knock stuns 60% of the time.",
				"mods": [{"skill": 0, "effect_chance": 60}]},
			{"id": "mc_sugar", "name": "甜白如糖", "name_en": "White as Sugar", "desc": "甜白护持冷却-1。", "desc_en": "Sweet-White Ward cooldown -1.",
				"mods": [{"skill": 1, "cd": -1}]},
			{"id": "mc_yongxuan", "name": "永宣", "name_en": "Yongle-Xuande", "desc": "永乐之光同时让全体队友攻击条+20%。", "desc_en": "Light of Yongle also gives allies 20% Attack Bar.",
				"mods": [{"skill": 2, "add_effect": {"type": "atb_boost_allies", "amount": 20}}]},
		],
	},
}
...
const BOSS := {
	...
	"base": {"hp": 5200, "atk": 880, "def": 540, "spd": 110, "crit_rate": 20, "crit_dmg": 60, "acc": 35, "res": 40},
	"leader": {},
	"passive": {"id": "unmended", "name": "拒绝修补", "name_en": "Refuses the Gold",
		"desc": "场上每有单位碎裂，攻击条+25%并恢复6%生命。每回合伤害+6%（盘面在崩塌）；生命低于50%时狂怒，伤害再+30%。",
		"desc_en": "Whenever anything shatters, gains 25% Attack Bar and heals 6%. Deals +6% damage each turn (the plate is crumbling); below 50% HP it enrages for another +30%."},
	"skills": [
		{"name": "裂口", "name_en": "Jagged Maw", "cd": 0, "target": "enemy", "mult": 3.8, "hits": 1, "crack": 35, "anim": "melee",
			...
			"effects": [{"type": "debuff", "status": "def_break", "turns": 2, "chance": 60}]},
		{"name": "碎瓷风暴", "name_en": "Shard Storm", "cd": 3, "target": "all_enemies", "mult": 1.15, "hits": 2, "crack": 30, "anim": "cast",
			"desc": "甩出身上的碎瓷两次攻击全体，50%几率【持续伤害】。", "desc_en": "Hurls its shards at everyone twice. 50% Continuous Damage.",
			"effects": [{"type": "debuff", "status": "dot", "turns": 2, "chance": 50}]},
		{"name": "万片归墟", "name_en": "Ten Thousand Fragments", "cd": 0, "target": "all_enemies", "mult": 2.4, "hits": 1, "crack": 45, "anim": "ultimate",
...
static func build_skills(sid: String, upgrades: Array) -> Array:
	...
	for uid in upgrades:
		...
		for m in up.get("mods", []):
			...
			if m.has("shield_add"):
				for e in sk.effects:
					if e.type == "shield_allies":
						e.pct = int(e.pct) + int(m.shield_add)
			if m.has("heal_add"):
				for e in sk.effects:

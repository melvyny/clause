...
const UI := {
	...
	"legend": ["规则：元素裂变 · 状态 · 操作", "Rules: reactions · statuses · controls"],
	"log": ["战斗记录", "Combat log"],
	...
	"battle_hint": ["点击目标释放 · [1][2][3] 切换技能（群体技能再按一次释放） · [空格] 自动选目标 · 头顶箭头：绿▲克制 黄◆无克制 红▼被克 · 悬停任何图标或角色查看说明",
		"Click a target · [1][2][3] switch skill (press an area skill again to cast) · [Space] auto-target · arrows: green ▲ advantage, yellow ◆ neutral, red ▼ disadvantage · hover any icon or unit for details"],

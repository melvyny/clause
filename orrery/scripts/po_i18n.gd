...
const UI := {
	...
	"rules_ke": ["[b]相克[/b]（伤害+25%%，裂纹+50%%；反过来伤害-15%%，裂纹-30%%）：%s", "[b]Overcoming[/b] (+25%% damage, +50%% crack; the reverse -15%% / -30%%): %s"],
	"rules_sheng": ["[b]相生[/b]（连携）：%s", "[b]Generating[/b] (chains): %s"],
	"ke_word": ["克", " overcomes "],
	"sheng_word": ["生", " feeds "],
	"rules_crack_title": ["裂纹与崩裂", "Crack and Break"],
	"rules_crack": ["每次攻击都会在目标身上留下[b]裂纹[/b]（名字下方的白条）。裂纹达到[b]胎厚[/b]时目标[b]崩裂[/b]：攻击条-35%、蓄力招式被打断、受到伤害+30%直到它下次行动。治疗技能会先用金子[b]修补裂纹[/b]。崩裂还会按[b]击碎者的元素[/b]触发窑变：",
		"Every attack leaves [b]crack[/b] (the white bar under a name). When crack reaches the target's [b]toughness[/b] it [b]breaks[/b]: it loses 35% Attack Bar, its telegraphed move is interrupted, and it takes +30% damage until it acts again. Healing skills [b]mend crack[/b] first. A break also fires a kiln effect set by the [b]breaker's element[/b]:"],
	...
	"reward_level": ["存活的器灵升 1 级，并恢复30%生命", "Survivors gain 1 level and recover 30% HP"],
